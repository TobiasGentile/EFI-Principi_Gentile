...
class Equipo(db.Model):
    ...
    stock = db.relationship('Stock', uselist=False, backref='equipo', lazy=True)  # Relación con backref
    caracteristicas = db.relationship('Caracteristica', backref='equipo', lazy=True)
    accesorios = db.relationship('AccesorioEquipo', backref='equipo', lazy=True)
