...
with app.app_context():
    ...
    def equipo_edit(id):
        ...
        if form.validate_on_submit():
            ...
            equipo.proveedor_id = form.proveedor_id.data
...
def ver_caracteristica(id):
    # Obtén la característica usando el id, o devuelve un error 404 si no se encuentra.
...
@app.route('/caracteristica/<int:id>/editar', methods=['GET', 'POST', 'PUT'])
